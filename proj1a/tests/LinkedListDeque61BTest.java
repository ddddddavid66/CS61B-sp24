...
public class LinkedListDeque61BTest {
    ...
    public void removeMixedTest() {
        ...
        assertThat(dq.removeFirst()).isEqualTo(1); // [2,3,4]
        assertThat(dq.removeLast()).isEqualTo(4);   // [2,3]

        assertThat(dq.toList()).containsExactly(2, 3).inOrder();
    }
    @Test
    public void removeOnEmptyDeque() {
        Deque61B<Integer> dq = new LinkedListDeque61B<>();
    ...
    public void singleElementTest() {
        ...
        assertThat(dq.getRecursive(0)).isEqualTo("A");
    ...
    @Test
    public void basicEmptyAndSizeTest() {
        Deque61B<Integer> dq = new LinkedListDeque61B<>();
